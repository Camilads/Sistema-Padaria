            ...
            card.innerHTML = `
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <p class="card-text">${tempoDecorrido >= tempoPreparo ? 'Fornada pronta há ' + formatarTempo(tempoDecorrido - tempoPreparo) : 'Tempo restante: ' + formatarTempo(tempoPreparo - tempoDecorrido)}</p>
                    </div>
                </div>
            `;
